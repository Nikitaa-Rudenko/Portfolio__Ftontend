...
const BODY_FIXED_CLASSNAME_SECOND = 'body_fixed';

const bodyNode_SECOND = document.querySelector('body');
...
function toggleBurger() {
    ...
    bodyNode_SECOND.classList.toggle(BODY_FIXED_CLASSNAME_SECOND);
